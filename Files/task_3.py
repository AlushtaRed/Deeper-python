...
def riding_files(names, nums):
    with open(names, 'r', encoding='utf-8') as names, open(nums, 'r', encoding='utf-8') as nums, open('task_3.txt', 'w', encoding='utf-8') as result:
...
riding_files('task_2.txt', 'task_1.txt')